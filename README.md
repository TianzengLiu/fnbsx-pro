Dec 19 updated version, changed all lare to fnb except for the server link, changed wallets page lare to fnb, wallets2, wallets3 not not changed yet. Wallets are working.
