	...
	render(){
		return (
			<div className="pageContent">
				...
				<p className="mainTitle" style={{"color":"white", "fontSize":"40px"}}>Learn to build your dream</p>
				</div>
				<div className="fnbXTokenAnythingWrap card6">
				<div className="row2">
				<p className="firstTitle" style={{"color":"black"}}>We dream about a world...</p>
				<p className="paraDescr" style={{"color":"black"}}>where a small-time director with a beautiful script has
				as much access to capital as a director at a major production
				studio.</p>
				<p className="paraDescr" style={{"color":"black"}}>where a talented animator can skip university and raise
				enough money to complete a feature film before the age of
				twenty-one.</p>
				<p className="paraDescr" style={{"color":"black"}}>where an author in a third world country can fund the
				publishing of her first memoir which details political turmoil and
				newfound freedoms.</p>
				<p className="paraDescr" style={{"color":"black"}}>where an independent musician with an incredible melody
				can pre-sell his intellectual property so that he can afford studio
				time.</p>
				<p className="paraDescr" style={{"color":"black"}}>where a digital artist can create obscure content and
				assign a one-off license that need only appeal to an avid collector,
				not a mass audience, to have value.</p>
				<p className="paraDescr" style={{"color":"black"}}>where a superfan can own a percentage of the copyright of
			...
			{/* Tonys Cards for Team, Cards Start */}
				 ...
				 <div class="column">
				   ...
				   <br />
				   <h5 style={{"color":"black"}}>Ron Mears</h5>
				 ...
				 <br />
				 <h5 style={{"color":"black"}}>Tianzeng Liu</h5>
				 ...
				 <br />
				 <h5 style={{"color":"black"}}>Eytan Shander</h5>
				 <p className="text-muted role">Director of Media</p>
				 <hr />
				 <p className="school">Fox 29 News Philadelphia</p> 
				 <a target="_blank" href="https://www.linkedin.com/in/ronaldmears/">
				   	<i className="fa fa-linkedin"></i>
				 </a>				 
				 </div>
				 ...
				 <div class="column">
				 <div class="card">
				 <img src={require("../site/Brendan.jpeg")} />
				 <br />
				 <h5 style={{"color":"black"}}>Brendan Sturm</h5>
				 <p className="text-muted role">Blockchain Engineer</p>
				 <hr />
				 <p className="school">Washington University</p> 
				 <a target="_blank" href="https://www.linkedin.com/in/brendansturm/">
				   	<i className="fa fa-linkedin"></i>
				 </a>				 
				 </div>
				 </div>
				...
				<div className="row2">
				<p className="firstTitle" style={{"color":"black"}}>The dream is real...</p>
				<p className="paraDescr" style={{"color":"black"}}>Fanbase puts media ownership in the hands of the
				...
				<div className="row2">
				<p className="firstTitle" style={{"color":"black"}}>Are you a dreamer and a doer?</p>
				<p className="paraDescr" style={{"color":"black"}}>Right now we have paid internships available for writers, video editors, and animators with a deep knowledge of 
				blockchain technology and cryptocurrency.</p>
	...
	render(){
		return (
				<div className="pageContent">
					...
					{
						this.props.type == "dash" ?
						<p style={{"paddingTop":"80px","paddingBottom":"80px"}} className="mainTitle">Website Terms and Conditions of Use</p>
						:
					...
					<div className="row2">
						...
						{/*<ul style={{"marginLeft": "30px","paddingBottom":"10px"}}>
							<li className="paraDescrli">
								...
								An individual or a merchant who initiated in the Use of the fanbase website and or in the purchase procedure of FNB separately specified by FNB.
							</li><br />
							<li className="paraDescrli">
								<p style={{"paddingLeft": "0"}}  className="paraTitle">FNB Officials</p>
								Members of FNB and related persons.
							</li><br />
							<li className="paraDescrli">
								<p style={{"paddingLeft": "0"}}  className="paraTitle">FNB website</p>
								Website which domain is  or otherwise any other domain which is forwarded from https://fnbsx.com, operated and managed by FNB (If the domain or content of FNB's website has changed, regardless as the reason of the change, the changed domain is also described as FNB website).
							</li><br />
				</ul>*/}
