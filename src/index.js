...
import {Creators} from "./app/dashboard/creators/creators";
import {NewsPage} from "./app/dashboard/news/news";
import {IndexPage,TokenSaleSite,TokenSaleSite2} from "./site/main";
import {RoadmapSite} from "./site/roadmap/roadmap";
import {TermSite,PrivacySite,AMLCFTSite,TokensalepolicySite} from "./site/legal/terms";
...
//export const startUrl = "https://othercoin.com/test/#/";
export const startUrl = "http://fanthebase.com/#/";
		...
		return (
			<HashRouter>
				<Switch>
					...
					<Route exact path="/tokensale2" component={TokenSaleSite2} />
