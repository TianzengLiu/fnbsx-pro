...
import {PortfolioSummary2, PortfolioTable2} from "../widgets";
						...
						<div className="dashModal indexPagePortofilo" style={{"width":"40%"}}>
							<div className="content" style={{"height":"700px"}}>
								<div className="cHeader">
									<p className="title sub-title">Portfolio Summary</p>
								</div>
								<div className="cBody">
				...
				<div className="page">
					...
					<div className="dashWrapperB ">
						<div className="dashModal PortfolioPageWrap mobileVerisonHide" style={{"width":"40%"}}>
							<div className="content " style={{"height":"auto", "box-shadow": "0 4px 8px 0 rgba(0, 0, 0, 0.2)", "border-radius": "5px"}}>
								<div className="cHeader">
									<p className="title sub-title">My Tokens</p>
								</div>
								<div className="cBody">
						...
						</div>
						{
							...
							<div className="dashModal PortfolioSummaryWrap" style={{"width":"60%"}}>
							{
								...
								<div className="content" style={{"height":"400px", "box-shadow": "0 4px 8px 0 rgba(0, 0, 0, 0.2)", "border-radius": "5px"}}>
									<div className="cHeader">
										<p className="title sub-title">Portfolio Summary <a onClick={(e) => this.setState({"view2Summary":!this.state.view2Summary})} className="pull-right viewallA">Token Summary</a></p>
									</div>
									<div className="cBody">
						...
						<div className="dashModal PortfolioPageWrap mobileVersionShow" style={{"width":"40%", "box-shadow": "0 4px 8px 0 rgba(0, 0, 0, 0.2)", "border-radius": "5px"}}>
							<div className="content " style={{"height":"auto"}}>
								<div className="cHeader">
						...
						<div className="dashModal historySummaryWRap" style={{"width":"60%"}}>
							<div className="content" style={{"max-height":"460px", "box-shadow": "0 4px 8px 0 rgba(0, 0, 0, 0.2)", "border-radius": "5px"}}>
								<div className="cHeader">
								{
				...
				<div className="page">
					...
					<div className="dashWrapperB ">
						<div className="dashModal PortfolioPageWrap mobileVerisonHide" style={{"width":"40%"}}>
							<div className="content " style={{"height":"auto", "box-shadow": "0 4px 8px 0 rgba(0, 0, 0, 0.2)", "border-radius": "5px"}}>
								<div className="cHeader">
									<p className="title sub-title">My Tickets</p>
								</div>
								<div className="cBody">
									<PortfolioTable2 handleBoxChange={this.handleBoxChange} />
								</div>
							</div>
						</div>
						{
...
export class Wallets3 extends React.Component {
	...
	ReactGA.pageview(window.location.pathname + window.location.search);
		...
		window.scrollTo(0, 0)
		document.title = "My Collectibles – FNB";
		var r = this;
		var Users = Parse.Object.extend("_User");
		var query = new Parse.Query(Users);
		query.get(Parse.User.current().id, {
...
export class Exchange2 extends React.Component {
	...
	componentDidMount(){
		...
		window.scrollTo(0, 0)
		document.title = "Buy Tickets – FNB";
		var Users = Parse.Object.extend("_User");
		var query = new Parse.Query(Users);
		query.get(Parse.User.current().id, {
		success: function(results) {
								...
								<br style={{"clear":"both"}} />
									...
									<div className="dashModal contentPage" style={{"width":"50%","paddingLeft":"0"}}>
										<div className="socialLinks" style={{"paddingTop":"20px","textAlign":"center"}}>
											...
											<FacebookShareButton url="https://www.facebook.com/FNBSX/" quote={this.state.referralLink}>
												<div style={{"textAlign":"center"}} className="facebook">
										         	<i className="fa fa-facebook"></i>
												</div>
											 </FacebookShareButton>
											 <TwitterShareButton url="https://twitter.com/fanbasecoin" title="Fanbase Share Link Description">
												<div style={{"textAlign":"center"}} className="twitter">
													<i className="fa fa-twitter"></i>
												</div>	
											</TwitterShareButton>
											 <LinkedinShareButton url="https://www.linkedin.com/company/fnbsx/" title="Fanbase Share Link Description">
