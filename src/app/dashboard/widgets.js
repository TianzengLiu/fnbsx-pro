...
export class PortfolioSummary2 extends React.Component {
	constructor(props){
		super(props);
		this.state = {
			"totalLare":"0",
					...
					<div className="protfoilioWrapper">
				     ...
				     <ul className="pieID legend">
					      <li>
					        ...
					        <span className="dataPointH">0</span> 
					        <span className="dataPoint">0</span>
					        <p className="title">Total USDddddd</p>
					      </li>
					     <li>
					        <span className="circleL"><img src={BitcoinLogo} /></span>
					        <span className="dataPointH">0</span> 
					        <span className="dataPoint">0</span>
					        <p className="title">Bitcoinddddddd</p>
					      </li>
					      <li>
					        <span className="circleL"><img className="ethereumLogo" src={EthereumLogo} /></span>
					        <span className="dataPointH">0</span> 
					        <span className="dataPoint">0</span>
					        <p className="title">Ethereumddddd</p>
					      </li>
					      <li>
					        <span className="circleL"><img className="bitcoincash" src={BitcoinLogo} /></span>
					        <span className="dataPointH">0</span> 
					        <span className="dataPoint">0</span>
					        <p className="title">Bitcoin Cashdddd</p>
					      </li>
					      <li>
					        <span className="circleL"><img style={{"width":"13px"}} src={LitecoinLogo} /></span>
					        <span className="dataPointH">0</span> 
		...
		return (
			<div>
				<div className="porfolioTable mywalletsWidget">
					<ul>
						<li>
							<div className="logoP fnb"><img src={LogoSW} /></div>
							...
							<div className="mobileWidthhundred">
								<span className="pull-right"><Link to="exchange"><span className="buyNowBttn deposit" coinsend="FNB" totalLareBalance={this.state.totalLare} >Deposit</span></Link></span>
								<span className="pull-right"><span className="buyNowBttn tradeBttn" type="withdraw" coinsend="FNB" totalLareBalance={this.state.totalLare} onClick={this.props.handleBoxChange}>Send</span></span>
						...
						<li>
							...
							<div className="porfolioDetails">
								<span>Fanboy- Level 8: Baseship</span>
								<span>20.0000 LV8 = $20.00</span>
							</div>
							<div className="mobileHide">
{/*								<span className="pull-right"><Link className="buyNowBttn tradeBttn" to="/exchange">Trade</Link></span>
*/}								<span className="pull-right"><span className="buyNowBttn tradeBttn">Send</span></span>
						...
						<li>
							...
							<div className="porfolioDetails">
								<span>Fanboy- Level 7: Night Wrider</span>
								<span>1.0000 LV7= $1.00</span>
							</div>
							<div className="mobileHide">
{/*								<span className="pull-right"><Link className="buyNowBttn tradeBttn" to="/exchange">Trade</Link></span>
*/}								<span className="pull-right"><span className="buyNowBttn tradeBttn">Send</span></span>
						...
						<li>
							...
							<div className="porfolioDetails">
								<span>Fanboy- Level 6: Fantasy</span>
								<span>1.0000 LV6 = $1.00</span>
							</div>
							<div className="mobileHide">
{/*								<span className="pull-right"><Link className="buyNowBttn tradeBttn" to="/exchange">Trade</Link></span>
*/}								<span className="pull-right"><span className="buyNowBttn tradeBttn">Send</span></span>
						...
						<li>
							...
							<div className="porfolioDetails">
								<span>Mears Media Group</span>
								<span>1.0000 MMG = $1.00</span>
							</div>
							<div className="mobileHide">
{/*								<span className="pull-right"><Link className="buyNowBttn tradeBttn" to="/exchange">Trade</Link></span>
*/}								<span className="pull-right"><span className="buyNowBttn tradeBttn">Send</span></span>
						...
						<li>
							...
							<div className="porfolioDetails">
								<span>The Shander Show</span>
								<span>1.0000 TSS = $50.00</span>
							</div>
							<div className="mobileHide">
{/*								<span className="pull-right"><Link className="buyNowBttn tradeBttn" to="/exchange">Trade</Link></span>
*/}								<span className="pull-right"><span className="buyNowBttn tradeBttn">Send</span></span>
						...
						<li>
							...
							<div className="porfolioDetails">
								<span>Westbrook-For The Record</span>
								<span>1.0000 FTR = $100.00</span>
							</div>
							<div className="mobileHide">
{/*								<span className="pull-right"><Link className="buyNowBttn tradeBttn" to="/exchange">Trade</Link></span>
*/}								<span className="pull-right"><span className="buyNowBttn tradeBttn">Send</span></span>
						...
						<li>
							...
							<div className="porfolioDetails">
								<span>Jay-Z & Bob Dylan- Magic Music</span>
								<span>10.0000 JYZ = $50.00</span>
							</div>
							<div className="mobileHide">
{/*								<span className="pull-right"><Link className="buyNowBttn tradeBttn" to="/exchange">Trade</Link></span>
*/}								<span className="pull-right"><span className="buyNowBttn tradeBttn">Send</span></span>
...
export class PortfolioTable2 extends React.Component {
	constructor(props){
		super(props);
		this.state = {
			"totalLare":"0",
				...
				<div className="porfolioTable mywalletsWidget">
					<ul>
						...
						<li>
							<div className="logoP bitcoin"><img src={BitcoinLogo} /></div>
							<div className="porfolioDetails">
								<span>FanboyYYY- Level 8: Baseship</span>
								<span>20.0000 LV8 = $20.00</span>
							</div>
							<div className="mobileHide">
{/*								<span className="pull-right"><Link className="buyNowBttn tradeBttn" to="/exchange">Trade</Link></span>
*/}								<span className="pull-right"><span className="buyNowBttn tradeBttn">Send</span></span>
						...
						<li>
							<div className="logoP ethereum"><img src={EthereumLogo} /></div>
							<div className="porfolioDetails">
								<span>FanboyYYY- Level 7: Night Wrider</span>
								<span>1.0000 LV7= $1.00</span>
							</div>
							<div className="mobileHide">
{/*								<span className="pull-right"><Link className="buyNowBttn tradeBttn" to="/exchange">Trade</Link></span>
