							...
							<div className={this.state.dropdown == true ? "dAccountDropdown visible" : "dAccountDropdown"}>
								<ul>
									...
									<a onClick={this.handleLogout}><li>Log out</li></a>
									{
										...
										<a href="https://fnbsx.github.io/admin/#/"><li>Admin Dashboard</li></a>
										: ""
									}
								</ul>
							</div>
								...
								<ul className="notifyContent">
									<a>
										<li className="active">
											...
											src="https://s3.amazonaws.com/othercoin/profileImages/0c14ca7cfdc9eb09635be45f446c1586_profileImagejpeg.jpeg" />
...
{/*						<NavLink to="/coins" activeClassName="active"><li>
						...
						<NavLink to="/exchange" activeClassName="active sub-title"><li>
							{/*<span style={{"marginTop":"1px"}} className="svgImage">{exchangeSVG}</span>*/} BUY TOKENS</li>
						</NavLink>	
						<NavLink to="/exchange2" activeClassName="active sub-title"><li>
							{/*<span style={{"marginTop":"1px"}} className="svgImage">{exchangeSVG}</span>*/} BUY TICKETS</li>
						</NavLink>
						<NavLink to="/wallets" activeClassName="active sub-title"><li>
					    {/*<span className="svgImage">{walletSVG}</span> */} MY TOKENS</li>
						</NavLink>
						<NavLink to="/wallets2" activeClassName="active sub-title"><li>
							{/*<span className="svgImage">{walletSVG}</span>*/} MY TICKETS</li>
						</NavLink>
						<NavLink to="/wallets3" activeClassName="active sub-title"><li>
							{/*<span className="svgImage">{walletSVG}</span>*/} MY COLLECTIBLES</li>
						</NavLink>
						<NavLink to="/referrals" activeClassName="active sub-title"><li>
...
export class SiteFooter2 extends React.Component {
	componentDidMount() {
	}
	render() {
		return (
