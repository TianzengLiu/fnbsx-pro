						...
						<ul className="coinWrapperUL" style={{"text-align":"left"}}>
							<li>
								<div className="content active" style={{"text-align":"center"}}>
									<div className="logoP fanbaseColor">
		...
		return (
			<div>
				<div className="cBody exchangeDetails">
					...
					<p className="amountofFnb">{calculateFnbAmount(prop,"total")} FNB</p>{/* {calculateFnbAmount(prop,"t")}*/}
						...
						<div className="ExchangeDetailsWrap">
							<ul>
								<li>
									...
									<p className="subtitle">{calculateFnbAmount(prop,"b")} FNB</p>
									<hr />
								</li>
								<li>
									<p className="title">Bonus Amount</p>
									<p className="subtitle" id="totalFnbAMount">{calculateFnbAmount(prop,"t")} FNB</p>
									<hr />
								</li>
								<li>
					...
					<div className="finalFeeWrap">
						...
						<span className="pull-right title">${calculateFnbAmount(prop,"subtotal")}</span>
						<div className="verticalLine"></div>
					</div>
					<div className="finalFeeWrap">
						<span className="pull-left title">Transaction Fee</span>
						<span className="pull-right title">${calculateFnbAmount(prop,"fee")}</span>
						<div className="verticalLine"></div>
					</div>
					<div className="finalFeeWrap">
						<span className="pull-left title">Total</span>
						<span className="pull-right title">${calculateFnbAmount(prop,"totalA")}</span>
						<div className="verticalLine"></div>
					</div>
				</div>
				{
...
function calculateFnbAmount(object,t) {
	...
	var fnbAmount = (parseFloat(object.amount) * totalPerDollar).toFixed(rRate);
	var fFnb = (fnbAmount - (fnbAmount * fee).toFixed(rRate));
	if (t == "t") {
		return comma(fFnb);		
	} else if (t == "b") {
		return comma((fFnb * parseFloat(object.bonusRate)/100).toFixed(rRate));
	} else if (t == "total") {
		var bonus = (fFnb * parseFloat(object.bonusRate)/100)
